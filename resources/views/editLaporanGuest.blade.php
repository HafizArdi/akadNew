            ...
            <div style="margin-top:50px;" class="row">
                <div class="col-md-12">
                    ...
                    <div class="col-md-12 mb-4">
                        <div class="card">
                            <div class="card-body">
                                <form enctype="multipart/form-data" action="/updateLaporanGuest/{{$edit->idLaporan}}" method="POST" style="border-radius: 0px;" class="form-horizontal group-border-dashed">
                                    {{ csrf_field() }}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <span><img id="foto" src="/laporan/{{$edit->fotoLaporan}}" class="img-fluid"  align=center></span>
                                        </div>
                                    </div>
                                    <div class="form-group">
