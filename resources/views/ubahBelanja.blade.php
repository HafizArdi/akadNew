                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="panel panel-default">
                                                    ...
                                                    <span class="navbar-brand text-size-24" ><i class="fa fa-list-alt"></i> Ubah Rincian Belanja Desa {{Auth::user()->kelurahanTinggal->kelurahan}}</span>
                                                    <hr class="mb-2">
                                                    <div class="panel-body">
                                                        <form enctype="multipart/form-data" action="/updateBelanja/{{$edit->idBelanja}}" method="POST" style="border-radius: 0px;" class="form-horizontal group-border-dashed">
                                                            {{ csrf_field() }}
                                                            <div class="form-group{{$errors->has ('bidang') ? 'has-error':''}}">
                                                                <label class="col-md-2 control-label">Status Laporan</label>
                                                                <div class="col-md-6">
                                                                    <select name="bidang" class="form-control">
                                                                        <option value="">{{$edit->belanjaBidang->bidang}}</option>
                                                            ...
                                                            <div class="form-group{{ $errors->has('rincian') ? ' has-error' : '' }}">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <input id="rincian" type="text" class="form-control" name="rincian" value="{{$edit->rincian}}" required autofocus>
                                                            ...
                                                            <div class="form-group{{ $errors->has('belanja') ? ' has-error' : '' }}">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <input id="belanja" type="text" class="form-control" name="belanja" value="{{$edit->belanja}}" required autofocus>
